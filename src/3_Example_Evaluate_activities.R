...
mAct=readRDS(file.path(OUT, "Out_5_Activities_20each_N240.rds"))
dfOverview=readRDS(file.path(OUT, "Out_2_Overview_simulation_20each_N240.rds"))
SCALE=TRUE
...
ggsave(file.path(OUT, "Out_6_Activities_20each_N240_with_Annotation_Heatmap.png"), 
       pOut1, width = 16, height = 16, units = "cm", bg = "white")
ggsave(file.path(OUT, "Out_6_Activities_20each_N240_with_Annotation_Heatmap.svg"), 
       pOut1, width = 16, height = 16, units = "cm", bg = "white")
...
ggsave(file.path(OUT, "Out_7_Activities_20each_N240_with_Annotation_Barplot.png"), 
       pOut3, width = 16, height = 6, units = "cm", bg = "white")
ggsave(file.path(OUT, "Out_7_Activities_20each_N240_with_Annotation_Barplot.svg"), 
       pOut3, width = 16, height = 6, units = "cm", bg = "white")
